#' Noise filtering through principal components (based on \strong{Rcpp})
#' 
#' Filter noise from a 'RasterStack' object by decomposing into principal 
#' components and subsequent reconstruction using only a subset of components.
#' 
...
denoiseC <- function(x,
  ...
  ## insert reconstructed values into raster template
